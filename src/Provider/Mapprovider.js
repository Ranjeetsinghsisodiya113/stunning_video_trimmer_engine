...
import {Colors,mediaprovider,config,localStorage,localimag,Currentltlg,Lang_chg} from './utilslib/Utils';
...
export default class Mapprovider extends Component {
    ...
    render() {
        ...
        <TouchableOpacity style={{paddingVertical:15,width:'20%',alignSelf:'center'}}  onPress={()=>{this.state.profile=='location'?this.locationupdatebtn():this.props.navigation.goBack()}}> 
            <View style={{width:'100%',alignSelf:'center'}} >
              <Text style={{color:Colors.buttoncolor,fontFamily:'Piazzolla-Light',fontSize:13,textAlign:'center'}}></Text>
             </View>
          </TouchableOpacity>
